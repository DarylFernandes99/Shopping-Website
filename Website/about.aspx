    ...
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!--Body-->
                <div class="body">
                    <br /><br />
                    <h1 style="text-align:center"><strong>ABOUT VIOLET <br /><br /><br /></strong></h1>
                    <p style="text-align:center"><strong>Welcome to VIOLET, your number one source for all products, ie: shoes, bags,clothes,electronic devices and much more!!!.<br /><br/>
                  VIOLET was founded in 2010 by  with the motive to bring all products under one platform  <br /><br />

                  Our mission is to provide customer satisfaction by providing them with best of everything that we have to offer <br /><br />
                  We're dedicated to giving you the best of every products, with a focus on three characteristics, i.e: dependability, customer service and uniqueness. <br /><br />
                  We have wide range of products of all brands like NIKE, ADIDAS, DELL you name it... and different varities too to fulfil your fashion desires!!!<br /><br />
                  We hope you enjoy our products as much as we enjoy offering them to you. If you have any questions or comments, please don't hesitate to contact us. </strong></p>
                </div>
            <!--Body-->
