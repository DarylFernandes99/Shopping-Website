...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!--Body-->
                <div class="body">
                    <asp:Label ID="lblLoginMsg" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="XX-Large" style="left: 680px; top: 10px; position: absolute" Text="Contact Us"></asp:Label>
                    <div style="top: 100px; position: relative; text-align: center; font-size: large">
                        <asp:Label ID="lblErrorMsg" runat="server" Text="Message Submitted Successfully" Font-Size="Large" ForeColor="Green" Visible="False"></asp:Label>
                        <br /><br />
                        ...
                        <textarea id="txtMessage" runat="server" cols="20" rows="2" style="width: 300px; height:100px" placeholder="Enter your Message here..."></textarea>
                            <br />
                            <asp:RequiredFieldValidator ID="validateMessage" runat="server" ErrorMessage="Message Field cannot be left blank" ControlToValidate="txtMessage" ForeColor="Red" SetFocusOnError="True" ></asp:RequiredFieldValidator>
                        <br/><br />

                        <!--Buttons-->
                            <asp:Button ID="Submit" runat="server" Text="Button" Font-Size="Large" OnClick="Submit_Click" />
                            &nbsp &nbsp &nbsp &nbsp
