            ...
            <!--Body-->
                <div class="body">
                    ...
                    <div style="top: 100px; position: relative; text-align: center; font-size: large">
                        ...
                        <br />
                        <asp:TextBox ID="txtName" runat="server" style="width: 300px; height: 30px" placeholder="Enter Username / Email-ID..."></asp:TextBox>
                            <br />
                        ...
                        <!--Buttons-->
                            ...
                            <br /><br />
                            <asp:HyperLink ID="forgotPassword" runat="server" ForeColor="Black" NavigateUrl="~/forgotpass.aspx">Forgot Password? <br /> Click here.</asp:HyperLink>
                            <br /><br />
                    </div>
                </div>
            <!--Body-->
