            ...
            <!--Header-->
                <div class="header">
                    <div style="z-index: 1; top: 0px; width: 100%; height: 100px; position: fixed; left: 0px; background-color: white">
                        ...
                        <asp:Menu ID="HeaderMenu" runat="server" Style="top: 30px; left: 250px; position: absolute" Font-Size="Large" Orientation="Horizontal" RenderingMode="Table" DisappearAfter="100" DynamicHorizontalOffset="2" Font-Names="Verdana" ForeColor="black" StaticSubMenuIndent="20%">
                            ...
                            <Items>
                                ...
                                <asp:MenuItem Text="Shop" Value="Shop">
                                    ...
                                    <asp:MenuItem Text="Product Page" Value="Product Page"></asp:MenuItem>
                        ...
                        <a href="index.aspx" style="top: 30px; left: 1300px; position: absolute"><img src="img/icons/search.png" alt="Search"/></a>
                        <a href="index.aspx" style="top: 30px; left: 1350px; position: absolute"><img src="img/icons/man.png" alt="Profile"/></a>
                        <a href="index.aspx" style="top: 30px; left: 1400px; position: absolute"><img src="img/icons/bag.png" alt="Cart"/></a>
                    </div>
