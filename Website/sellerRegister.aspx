...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <!--Body-->
                <div class="body">
                    <asp:Label ID="lblSignupMsg" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="XX-Large" style="left: 600px; top: 10px; position: absolute" Text="Seller Registration Page"></asp:Label>
